...
public class PolicyJsonFront {
	...
	/**
	 * Identificador del user del policy
	 */
	@JsonProperty("policyUser")
	private int policyUser;

	public PolicyJsonFront()
	{}



	public PolicyJsonFront(String endPoint, String numSessions, String bandwidthUP, String bandwidthDOWN,
	...
	public void setPolicyUser(int policyUser) {
	...
	public String toString() {
		return "PolicyJson [endPoint=" + endPoint + ", numSessions=" + numSessions + ", bandwidthUP=" + bandwidthUP
				+ ", bandwidthDOWN=" + bandwidthDOWN + ", pingMaxDelay=" + pingMaxDelay + ", policyID=" + policyID
